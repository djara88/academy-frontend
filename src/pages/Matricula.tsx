      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="card p-6">
          ...
          <input
            ...
            className="w-full border-none bg-[#1c2331] p-2 rounded-lg text-white"
          />
          {fotoBase64 && (
            <img
              src={fotoBase64}
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-[#238636] hover:bg-[#2ea043] text-white font-bold text-lg py-3 px-8 rounded-lg shadow-lg focus:outline-none disabled:opacity-50 transition-all flex items-center justify-center gap-2 w-full"
        >
          {loading ? (
            <>
            ...
            '💾 Confirmar Matrícula y Generar PDF'
          )}
        </button>
      </form>
    </div>
